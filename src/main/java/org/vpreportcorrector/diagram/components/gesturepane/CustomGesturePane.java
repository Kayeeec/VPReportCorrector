package org.vpreportcorrector.diagram.components.gesturepane;
...
import static org.vpreportcorrector.diagram.components.gesturepane.CustomGesturePane.FitMode.FIT;
import static org.vpreportcorrector.diagram.components.gesturepane.CustomGesturePane.FitMode.UNBOUNDED;
import static org.vpreportcorrector.diagram.components.gesturepane.CustomGesturePane.ScrollBarPolicy.AS_NEEDED;
import static org.vpreportcorrector.diagram.components.gesturepane.CustomGesturePane.ScrollMode.PAN;

/**
 * Pane that applies transformations to some implementation of {@link CustomGesturePane.Transformable} when a
 * gesture is applied
 * <p>
 * Terms:
 * <ol>
...
public class CustomGesturePane extends Control implements GesturePaneOps {
    ...
    final ObjectProperty<CustomGesturePane.ScrollBarPolicy> vbarPolicy = new SimpleObjectProperty<>(AS_NEEDED);
    final ObjectProperty<CustomGesturePane.ScrollBarPolicy> hbarPolicy = new SimpleObjectProperty<>(AS_NEEDED);
    ...
    final ObjectProperty<CustomGesturePane.ScrollMode> scrollMode = new SimpleObjectProperty<>(PAN);
    final ObjectProperty<CustomGesturePane.FitMode> fitMode = new SimpleObjectProperty<>(FIT);
    ...
    /**
     * For which mouse buttons is panning/moving the content (MOUSE_DRAGGED EVENT) enabled.
     */
    final SimpleSetProperty<MouseButton> panningMouseButtons = new SimpleSetProperty<>(
            FXCollections.observableSet(MouseButton.PRIMARY, MouseButton.MIDDLE)
    );

    final ObjectProperty<CustomGesturePane.Transformable> target = new SimpleObjectProperty<>();
    ...
    /**
     * Create a new {@link CustomGesturePane} with the specified {@link CustomGesturePane.Transformable}
     *
     * @param target the transformable to apply the transforms to
     */
    public CustomGesturePane(CustomGesturePane.Transformable target) {
        this();
        setTarget(target);
    }

    /**
     * Creates a new {@link CustomGesturePane} with the specified node as children(i.e the node gets
     * added to the pane)
     *
     * @param target the node to apply transforms to
     */
    public CustomGesturePane(Node target) {
        this();
        setContent(target);
    }

    public CustomGesturePane() {
        super();
    ...
    @Override
    protected Skin<?> createDefaultSkin() { return new CustomGesturePaneSkin(this); }
     ...
     */
    public CustomGesturePane.AnimationInterpolatorBuilder animate(Duration duration) {
        Objects.requireNonNull(duration);
        // keep the builder to one object instantiation
        return new CustomGesturePane.AnimationInterpolatorBuilder() {
            ...
            @Override
            public CustomGesturePane.AnimationStartBuilder interpolateWith(Interpolator interpolator) {
                this.interpolator = Objects.requireNonNull(interpolator);
                return this;
            }
            @Override
            public CustomGesturePane.AnimationEndBuilder beforeStart(Runnable action) {
    ...
    public interface AnimationInterpolatorBuilder extends CustomGesturePane.AnimationStartBuilder {
        /**
         * @param interpolator the interpolator to use for the animation
         * @return the next group of configurable options in a type-safe builder
         */
        CustomGesturePane.AnimationStartBuilder interpolateWith(Interpolator interpolator);
    }

    public interface AnimationStartBuilder extends CustomGesturePane.AnimationEndBuilder {
        /**
         * @param action the action to execute <b>before</b> the animation starts
         * @return the next group of configurable options in a type-safe builder
         */
        CustomGesturePane.AnimationEndBuilder beforeStart(Runnable action);
    }
     ...
     */
    public CustomGesturePane.Transformable getTarget() { return target.get(); }
    public ObjectProperty<CustomGesturePane.Transformable> targetProperty() { return target; }
    public void setTarget(CustomGesturePane.Transformable target) { this.target.set(target); }
     ...
     */
    public CustomGesturePane.ScrollBarPolicy getVbarPolicy() { return vbarPolicy.get(); }
    public ObjectProperty<CustomGesturePane.ScrollBarPolicy> vbarPolicyProperty() { return vbarPolicy; }
    public void setVbarPolicy(CustomGesturePane.ScrollBarPolicy policy) { this.vbarPolicy.set(policy); }


    /**
     * @return which scrollbar policy the horizontal scrollbar uses
     */
    public CustomGesturePane.ScrollBarPolicy getHbarPolicy() { return hbarPolicy.get(); }
    public ObjectProperty<CustomGesturePane.ScrollBarPolicy> hbarPolicyProperty() { return hbarPolicy; }
    public void setHbarPolicy(CustomGesturePane.ScrollBarPolicy policy) { this.hbarPolicy.set(policy); }

    /**
     * Sets the same scrollbar policy for both vbar and hbar
     */
    public void setScrollBarPolicy(CustomGesturePane.ScrollBarPolicy policy) {
    ...
    public ObservableSet<MouseButton> getPanningMouseButtons() { return panningMouseButtons.get(); }
    public SimpleSetProperty<MouseButton> panningMouseButtonsProperty() { return panningMouseButtons; }
    public void setPanningMouseButtons(ObservableSet<MouseButton> mouseBtns) { this.panningMouseButtons.set(mouseBtns); }
    ...
    /**
     * @return the current {@link CustomGesturePane.FitMode}
     */
    public CustomGesturePane.FitMode getFitMode() { return fitMode.get(); }
    public ObjectProperty<CustomGesturePane.FitMode> fitModeProperty() { return fitMode; }
    public void setFitMode(CustomGesturePane.FitMode mode) { this.fitMode.set(mode); }

    /**
     * @return the current {@link CustomGesturePane.ScrollMode}
     */
    public CustomGesturePane.ScrollMode getScrollMode() { return scrollMode.get(); }
    public ObjectProperty<CustomGesturePane.ScrollMode> scrollModeProperty() { return scrollMode; }
    public void setScrollMode(CustomGesturePane.ScrollMode mode) { this.scrollMode.set(mode); }

    /**
     * @return the current minimum scale; defaults to {@link CustomGesturePane#DEFAULT_MIN_SCALE}
     */
    ...
    /**
     * @return the current maximum scale; defaults to {@link CustomGesturePane#DEFAULT_MAX_SCALE}
     */
    ...
    /**
     * @return the current scale; defaults to 1.0 initially unless the selected {@link CustomGesturePane.FitMode}
     * disallows this
     */
     ...
     * {@link CustomGesturePane#getTargetViewport()}
     */
